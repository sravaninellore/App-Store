...
class AppStore extends Component {
  ...
  changeTabItem = clickedTabId => this.setState({activeTabId: clickedTabId})
  ...
  getFilteredApps = () => {
    ...
    const filteredAppsByUserInput = filteredAppsByCategory.filter(eachApp =>
      eachApp.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )

    return filteredAppsByUserInput
  }
